...
/** Per-node bytes received counter. */
std::vector<uint32_t> bytesReceived{0, 0, 0, 0};
...
/**
 * Convert a context string to a Node id
...
/**
 * Accumulate bytes received for a Node
 * @param context The Node
 * @param p The Packet
 */
void
SocketRx(std::string context, Ptr<const Packet> p, const Address&)
{
...
/**
 * Log resets by node context.
 * @param context The context.
 * @param bssColor Reset parameter.
 * @param rssiDbm Reset parameter.
 * @param powerRestricted Reset parameter.
 * @param txPowerMaxDbmSiso Reset parameter.
 * @param txPowerMaxDbmMimo Reset parameter.
 */
void
