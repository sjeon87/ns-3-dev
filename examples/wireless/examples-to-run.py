...
cpp_examples = [
    ...
    (
        # regression: EMLSR TXOP start during stale TXOP-end tracking must block the other links
        "wifi-eht-network --simulationTime=0.3s --frequency=2.4 --frequency2=5 --frequency3=6 --guardInterval=1600 --udp=0 --downlink=0 --useRts=1 --mpduBufferSize=512 --emlsrLinks=0,1,2 --emlsrPaddingDelay=64 --emlsrTransitionDelay=64 --channelSwitchDelay=64us --emlsrAuxSwitch=False --emlsrAuxTxCapable=True --nStations=4 --dlAckType=MU-BAR --enableUlOfdma=1 --enableBsrp=1 --mcs=4 --channelWidth=20 --ns3::Txop::TxopLimits=2528us,2528us,2528us --minExpectedThroughput=1 --maxExpectedThroughput=10000",
        "True",
        "True",
    ),
    (
