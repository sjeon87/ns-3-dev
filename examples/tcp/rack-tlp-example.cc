...
// All the pcaps will be collected in a folder named rack-tlp in the ns-3 root directory.
Ptr<UniformRandomVariable> uv = CreateObject<UniformRandomVariable>();
std::string dir = "rack-tlp/example/";
double stopTime = 10;
...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("tlp", "Enable/Disable TLP (Tail Loss Probe)", tlp);
    cmd.AddValue("reorder", "Enable/Disable Reordering of packets", reorder);
