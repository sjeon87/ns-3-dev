 ...
 * distribution.
 * The default configurations of packet size and packet time distributions
...
class TrafficGeneratorNgmnVideo : public TrafficGenerator
{
  ...
  private:
    ...
    uint32_t m_numberOfPacketsInFrame{0};
    /// Interframe interval time
    Time m_interframeIntervalTime{0};
    /// Pareto random variable for packet size generation
    Ptr<ParetoRandomVariable> m_packetSizeGenerator;
    /// Pareto random variable for packet time generation
    Ptr<ParetoRandomVariable> m_packetTimeGenerator;
    /// The scale parameter for the Pareto distribution for the packet size generation
    double m_packetSizeScale{0.0};
    /// The shape parameter for the Pareto distribution for the packet size generation
    double m_packetSizeShape{0.0};
    /// The bound parameter for the Pareto distribution for the packet size generation
    double m_packetSizeBound{0.0};
    /// The scale parameter for the Pareto distribution for the packet time generation
    double m_packetTimeScale{0.0};
    /// The shape parameter for the Pareto distribution for the packet time generation
    double m_packetTimeShape{0.0};
    /// The bound parameter for the Pareto distribution for the packet time generation
    double m_packetTimeBound{0.0};
    /// The packet frame counter generated by this application
    uint32_t m_packetFrameCounter{0};
    /// The global flow ID counter of video traffic generators
    static uint32_t m_flowIdCounter;
    /// The traffic generator flow ID of this instance
    uint32_t m_flowId{0};
};
