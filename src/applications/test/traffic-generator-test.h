 ...
 * @ingroup tests
 *
 * @brief Test that all the packets generated by the client application (e.g., NGMN VoIP,
...
class TrafficGeneratorTestCase : public TestCase
{
  public:
    /**
     * @brief Creates a new TrafficGeneratorTestCase instance with given parameters
     * @param name Name of the test case
     * @param trafficGeneratorType TypeId of the traffic generator to use
     * @param transportProtocol Protocol type (e.g., "Udp", "Tcp")
     */
 ...
 * @ingroup tests
 *
 * @brief Test that the packet size and packet arrival time is generated according to NGMN
 * parameters
 */
 ...
 * @ingroup tests
 *
 * @brief Test that the packet size and packet arrival times that are generated correctly
 ...
 * @ingroup tests
 *
 * @brief Test that the average throughput is equal to the average VoIP throughput as
...
class TrafficGeneratorNgmnVoipTestCase : public TestCase
{
  public:
    /**
     * @brief Creates a new TrafficGeneratorNgmnVoipTestCase instance
     * @param transportProtocol Protocol type (e.g., "Udp", "Tcp")
     */
 ...
 * @ingroup tests
 *
 * @brief Test that the HTTP variables are generated according to NGMN/3GPP parameters
 */
