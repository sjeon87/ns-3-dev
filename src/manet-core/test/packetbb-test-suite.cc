    ...
    : TestSuite("packetbb-test-suite", Type::UNIT)
{
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            ...
            0x08, 0x00, 0x02, 0x01, 0x00, 0x02, 0xf3, 0x00, 0x0e, 0x0a,
     ...
     */
    {
        ...
        msg2a1->PrefixPushBack(32);
        msg2->AddressBlockPushBack(msg2a1);

        packet->MessagePushBack(msg2);

        uint8_t buffer[] = {
            0x0c, 0x00, 0x0f, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x16, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x10, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x16, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x01, 0x00, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x11, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x16, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x12, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x16, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x01, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x13, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x16, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x01, 0x00, 0x0a, 0x00, 0x00, 0x01, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x14, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x18, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x02, 0x80, 0x03, 0x0a, 0x00, 0x00, 0x01, 0x02, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x15, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02, 0x01,
            0x00, 0x02, 0xf3, 0x00, 0x1a, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30, 0x39, 0x00,
            0x00, 0x02, 0xc0, 0x01, 0x0a, 0x01, 0x02, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x17, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x32, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x02, 0xc0, 0x01, 0x0a, 0x01, 0x02, 0x00, 0x00, 0x01, 0x01,
            0x00, 0x00, 0x04, 0x08, 0x0a, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x0a,
            0x00, 0x00, 0x05, 0x0a, 0x00, 0x00, 0x06, 0x20, 0x20, 0x10, 0x18, 0x00, 0x00,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x18, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02, 0x01,
            0x00, 0x02, 0xf3, 0x00, 0x34, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30, 0x39, 0x00,
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x19, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02, 0x01,
            0x00, 0x02, 0xf3, 0x00, 0x35, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30, 0x39, 0x00,
            0x00, 0x02, 0xc0, 0x01, 0x0a, 0x01, 0x02, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x04,
            0x08, 0x0a, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x05, 0x0a,
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x1a, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02, 0x01,
            0x00, 0x02, 0xf3, 0x00, 0x36, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30, 0x39, 0x00,
            0x00, 0x02, 0xc0, 0x01, 0x0a, 0x01, 0x02, 0x00, 0x00, 0x01, 0x01, 0x00, 0x00, 0x04,
            0x08, 0x0a, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x05, 0x0a,
            0x00, 0x00, 0x06, 0x20, 0x20, 0x10, 0x18, 0x00, 0x04, 0x01, 0x20, 0x01, 0x03,
        };
     ...
     */
    {
        ...
        uint8_t buffer[] = {
            0x0c, 0x00, 0x1b, 0x00, 0x02, 0x01, 0x00, 0x01, 0x03, 0x00, 0x08, 0x00, 0x02,
            0x01, 0x00, 0x02, 0xf3, 0x00, 0x3a, 0x0a, 0x00, 0x00, 0x01, 0xff, 0x01, 0x30,
            0x39, 0x00, 0x00, 0x02, 0xc0, 0x01, 0x0a, 0x01, 0x02, 0x00, 0x00, 0x01, 0x01,
            0x00, 0x00, 0x04, 0x08, 0x0a, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x0a,
            0x00, 0x00, 0x05, 0x0a, 0x00, 0x00, 0x06, 0x20, 0x20, 0x10, 0x18, 0x00, 0x08,
