...
class SessionId
{
  public:
    ...
    /**
     * @brief Check if two Session IDs are equal.
     * @param o The other SessionId to compare with.
     * @return true if equal.
     */
    bool operator==(const SessionId& o) const;

    /**
     * @brief Check if this Session ID is less than another.
     * @param o The other SessionId to compare with.
     * @return true if this object is strictly less than o.
     */
    bool operator<(const SessionId& o) const;
    ...
    static const uint32_t MAX_SESSION_NUMBER = 4294967295U; //!< Maximum session number value
...
/**
 * @brief Output stream operator for SessionId
 * @param os The output stream
 * @param pvf The SessionId to output
...
class LtpExtension
{
  public:
    ...
    /**
     * @brief Deserialize the extension.
    ...
    /**
     * @brief Check if two LtpExtensions are equal.
     * @param o The other LtpExtension to compare with.
     * @return true if equal.
     */
    bool operator==(const LtpExtension& o) const;
...
class LtpHeader : public Header
{
  public:
    ...
    /**
     * @brief Check if this type corresponds to a green data segment
     * @param type segment type.
     * @return true if data segment, false otherwise.
     */
    ...
    /**
     * @brief Check if two LtpHeaders are equal.
     * @param o The other LtpHeader to compare with.
     * @return true if equal.
     */
    bool operator==(const LtpHeader& o) const;
...
class LtpTrailer : public Trailer
{
  public:
    ...
    /**
     * @brief Check if two LtpTrailers are equal.
     * @param o The other LtpTrailer to compare with.
     * @return true if equal.
     */
    bool operator==(const LtpTrailer& o) const;
...
class LtpContentHeader : public Header
{
  public:
    /**
     * @brief A structure that stores offset and length for data segments.
     */
    class ReceptionClaim
    {
      public:
        uint64_t offset; //!< offset of the received data
        uint64_t length; //!< length of the received data

        /**
         * @brief Check if this ReceptionClaim is less than another.
         * @param o The other ReceptionClaim to compare with.
         * @return true if this object is strictly less than o.
         */
        bool operator<(const ReceptionClaim& o) const;
    };
     ...
     */
    LtpContentHeader(SegmentType segmentType);
    ...
    /**
     * @brief Check if two LtpContentHeaders are equal.
     * @param o The other LtpContentHeader to compare with.
     * @return true if equal.
     */
    bool operator==(const LtpContentHeader& o) const;

  private:
    SegmentType m_type; //!< Segment type for internal interpretation
    ...
    std::vector<ReceptionClaim> m_rxClaims; //!< Reception Claims list
...
/**
 * @brief Check equality of two ReceptionClaims
 * @param a First ReceptionClaim
 * @param b Second ReceptionClaim
 * @return True if offset and length are equal.
 */
bool operator==(const LtpContentHeader::ReceptionClaim& a,
                const LtpContentHeader::ReceptionClaim& b);
