...
BundleHeaderTestCase::DoRun()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(bytes1, pbb.GetSerializedSize(), "PrimaryBlockHeader serialized size mismatch");
    ...
    NS_TEST_ASSERT_MSG_EQ(pbb2.GetCreationTime(), Seconds(10), "PrimaryBlockHeader CreationTime mismatch");
    NS_TEST_ASSERT_MSG_EQ(pbb2.GetTTL(), Seconds(3600), "PrimaryBlockHeader TTL mismatch");
    NS_TEST_ASSERT_MSG_EQ(pbb2.GetSequenceNumber(), 42, "PrimaryBlockHeader SequenceNumber mismatch");
    NS_TEST_ASSERT_MSG_EQ(pbb2.GetDictionary(), pbb.GetDictionary(), "PrimaryBlockHeader Dictionary mismatch");
    ...
    NS_TEST_ASSERT_MSG_EQ(bytes2, plb.GetSerializedSize(), "PayloadBlockHeader serialized size mismatch");
    ...
    NS_TEST_ASSERT_MSG_EQ(bytes3, bsr.GetSerializedSize(), "BundleStatusReport serialized size mismatch");
    ...
    NS_TEST_ASSERT_MSG_EQ(bsr2.GetBundleReceiptTime(), Seconds(15), "BundleStatusReport ReceiptTime mismatch");
    NS_TEST_ASSERT_MSG_EQ(bsr2.GetCreationTime(), Seconds(5), "BundleStatusReport CreationTime mismatch");
    NS_TEST_ASSERT_MSG_EQ(bsr2.GetSequenceNumber(), 100, "BundleStatusReport SequenceNumber mismatch");
}
