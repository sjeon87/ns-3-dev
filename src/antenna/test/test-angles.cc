...
{
    AddTestCase(new OneVectorConstructorTestCase(Vector(1, 0, 0), Angles(0, (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(-1, 0, 0), Angles(PI, (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, 1, 0), Angles((PI / 2.0), (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, -1, 0), Angles(-(PI / 2.0), (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, 0, 1), Angles(0, 0)),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, 0, -1), Angles(0, PI)),
                TestCase::Duration::QUICK);

    AddTestCase(new OneVectorConstructorTestCase(Vector(2, 0, 0), Angles(0, (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(-2, 0, 0), Angles(PI, (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, 2, 0), Angles((PI / 2.0), (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, -2, 0), Angles(-(PI / 2.0), (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, 0, 2), Angles(0, 0)),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, 0, -2), Angles(0, PI)),
                TestCase::Duration::QUICK);

    AddTestCase(new OneVectorConstructorTestCase(Vector(1, 0, 1), Angles(0, (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(1, 0, -1), Angles(0, 3 * (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(1, 1, 0), Angles((PI / 4.0), (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(1, -1, 0), Angles(-(PI / 4.0), (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(-1, 0, 1), Angles(PI, (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(-1, 0, -1), Angles(PI, 3 * (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(
        new OneVectorConstructorTestCase(Vector(-1, 1, 0), Angles(3 * (PI / 4.0), (PI / 2.0))),
        TestCase::Duration::QUICK);
    AddTestCase(
        new OneVectorConstructorTestCase(Vector(-1, -1, 0), Angles(-3 * (PI / 4.0), (PI / 2.0))),
        TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, 1, 1), Angles((PI / 2.0), (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(
        new OneVectorConstructorTestCase(Vector(0, 1, -1), Angles((PI / 2.0), 3 * (PI / 4.0))),
        TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(0, -1, 1), Angles(-(PI / 2.0), (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(
    ...
    AddTestCase(new OneVectorConstructorTestCase(Vector(1, 1, std::sqrt(2)),
                ...
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(1, 1, -std::sqrt(2)),
                                                 Angles((PI / 4.0), 3 * (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(1, -1, std::sqrt(2)),
                                                 Angles(-(PI / 4.0), (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new OneVectorConstructorTestCase(Vector(-1, 1, std::sqrt(2)),
                                                 Angles(3 * (PI / 4.0), (PI / 4.0))),
                TestCase::Duration::QUICK);

    AddTestCase(
        new TwoVectorsConstructorTestCase(Vector(1, 0, 0), Vector(0, 0, 0), Angles(0, (PI / 2.0))),
        TestCase::Duration::QUICK);
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(-1, 0, 0),
                                                  Vector(0, 0, 0),
                                                  Angles(PI, (PI / 2.0))),
                TestCase::Duration::QUICK);
    ...
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(0, 0, 1), Vector(0, 0, 0), Angles(0, 0)),
                TestCase::Duration::QUICK);
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(0, 0, -1), Vector(0, 0, 0), Angles(0, PI)),
                TestCase::Duration::QUICK);

    AddTestCase(
        new TwoVectorsConstructorTestCase(Vector(2, 0, 0), Vector(0, 0, 0), Angles(0, (PI / 2.0))),
        TestCase::Duration::QUICK);
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(-2, 0, 0),
                                                  Vector(0, 0, 0),
                                                  Angles(PI, (PI / 2.0))),
                TestCase::Duration::QUICK);
    ...
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(0, 0, 2), Vector(0, 0, 0), Angles(0, 0)),
                TestCase::Duration::QUICK);
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(0, 0, -2), Vector(0, 0, 0), Angles(0, PI)),
                TestCase::Duration::QUICK);

    AddTestCase(
        new TwoVectorsConstructorTestCase(Vector(1, 0, 1), Vector(0, 0, 0), Angles(0, (PI / 4.0))),
        TestCase::Duration::QUICK);
    ...
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(0, 1, 1),
                                                  Vector(0, 0, 0),
                                                  Angles((PI / 2.0), (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(0, 1, -1),
                                                  Vector(0, 0, 0),
                                                  Angles((PI / 2.0), 3 * (PI / 4.0))),
                TestCase::Duration::QUICK);
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(0, -1, 1),
                                                  Vector(0, 0, 0),
                                                  Angles(-(PI / 2.0), (PI / 4.0))),
    ...
    AddTestCase(
        new TwoVectorsConstructorTestCase(Vector(3, 2, 2), Vector(2, 2, 2), Angles(0, (PI / 2.0))),
        TestCase::Duration::QUICK);
    AddTestCase(
        new TwoVectorsConstructorTestCase(Vector(1, 2, 2), Vector(2, 2, 2), Angles(PI, (PI / 2.0))),
        TestCase::Duration::QUICK);
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(2, 3, 2),
                                                  Vector(2, 2, 2),
                                                  Angles((PI / 2.0), (PI / 2.0))),
                TestCase::Duration::QUICK);
    ...
    AddTestCase(new TwoVectorsConstructorTestCase(Vector(4, -2, 7), Vector(4, -2, 6), Angles(0, 0)),
                TestCase::Duration::QUICK);
    AddTestCase(
        new TwoVectorsConstructorTestCase(Vector(0, -5, -1), Vector(0, -5, 0), Angles(0, PI)),
        TestCase::Duration::QUICK);

    AddTestCase(new TwoVectorsConstructorTestCase(Vector(-2, 2, -1),
                                                  Vector(-4, 2, -1),
                                                  Angles(0, (PI / 2.0))),
                TestCase::Duration::QUICK);
    AddTestCase(
        new TwoVectorsConstructorTestCase(Vector(2, 2, 0), Vector(4, 2, 0), Angles(PI, (PI / 2.0))),
        TestCase::Duration::QUICK);

    AddTestCase(new TwoVectorsConstructorTestCase(Vector(-1, 4, 4),
                                                  Vector(-2, 4, 3),
                                                  Angles(0, (PI / 4.0))),
                TestCase::Duration::QUICK);
    ...
    AddTestCase(new WrapToRangeTestCase(WrapToPi, -PI, PI), TestCase::Duration::QUICK);
    AddTestCase(new WrapToRangeTestCase(WrapTo360, 0, 360), TestCase::Duration::QUICK);
    AddTestCase(new WrapToRangeTestCase(WrapTo2Pi, 0, 2 * PI), TestCase::Duration::QUICK);
