 ...
 *
 * @brief Ipv[4,6]NetworkAddressTest Test
 */
...
IpvxNetworkAddressTest::IpvxNetworkAddressTest()
    : TestCase("ipvx-network-address test")
{
}
...
IpvxNetworkAddressTest::DoRun()
{
    ...
    NS_TEST_EXPECT_MSG_EQ(net1v4.GetNetwork() == Ipv4NetworkAddress(Ipv4Address("192.168.1.0"), 24),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ(net1v6.GetNetwork() ==
                              Ipv6NetworkAddress(Ipv6Address("2001:db8:cafe::"), 64),
                          true,
 ...
 * @ingroup network-test
 *
 * @brief Ipv[4,6]NetworkAddressTest TestSuite
 */
class IpvxNetworkAddressTestSuite : public TestSuite
{
  public:
    IpvxNetworkAddressTestSuite()
        : TestSuite("ipvx-network-address", Type::UNIT)
    {
