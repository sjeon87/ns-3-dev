...
int64_t
UnboundedSkewClock::AssignStreams(
    int64_t stream
)
{
...
UnboundedSkewClock::Now()
{
    ...
    double current_skew = 1.0; // Default skew is 1.0 (no skew)
...
UnboundedSkewClock::IncrementSkewIndex()
{
    ...
    m_index = (m_index + 1) % m_skew_values.size();
}
...
void
UnboundedSkewClock::SetSkewValues(
...
int64_t
UnboundedSkewClock::DoAssignStreams(
    int64_t stream
)
{
