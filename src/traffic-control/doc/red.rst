...
as the queue disc and having a size equal to the RED MaxQueueSize attribute
...
* Interval (time)
* LastSet (time)
* MinCurMaxP (lower limit of m_curMaxP)
* AREDAlpha (increment parameter for m_curMaxP in ARED)
* AREDBeta (decrement parameter for m_curMaxP in ARED)
* Rtt
...
* FengAlpha     (decrement parameter for m_curMaxP , Default: 3)
* FengBeta      (increment parameter for m_curMaxP, Default: 2)
...
.. sourcecode:: cpp
  ...
  Config::SetDefault("ns3::RedQueueDisc::QWeight", DoubleValue(0.0));
