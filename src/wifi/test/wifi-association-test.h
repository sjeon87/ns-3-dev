...
class WifiAssociationTestBase : public TestCase
{
  ...
  protected:
     ...
     */
    virtual void AssocSeenByAp(ApWifiMac* apMac, uint16_t aid, Mac48Address staAddress)
    {
    }
     ...
     */
    virtual void DisassocSeenByAp(ApWifiMac* apMac, uint16_t aid, Mac48Address staAddress)
    {
    }
...
class WifiDisassocAndReassocTest : public WifiAssociationTestBase
{
  ...
  protected:
    ...
    void AssocSeenByAp(ApWifiMac* apMac, uint16_t aid, Mac48Address staAddress) override;
    void DisassocSeenByAp(ApWifiMac* apMac, uint16_t aid, Mac48Address staAddress) override;
