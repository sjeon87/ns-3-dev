...
namespace
{
/// ICMPv4 Source Quench type, deprecated by RFC 6633 and not generated by ns-3
constexpr uint8_t ICMPV4_SOURCE_QUENCH = 4;
} // namespace
                           ...
                           const uint8_t payload[8])
{
    ...
    if (icmpType == ICMPV4_SOURCE_QUENCH)
    {
        // Source Quench messages must be silently discarded (RFC 9293,
        // Section 3.9.2.2, MUST-55)
        NS_LOG_LOGIC("Discarding an ICMP Source Quench message");
        return;
    }
