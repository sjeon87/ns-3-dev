...
{
    os << "( nextHeader = " << +GetNextHeader() << " length = " << +GetLength() << " )";
}
...
{
    os << "( nextHeader = " << +GetNextHeader() << " length = " << +GetLength()
       << " offset = " << +GetOffset() << " MF = " << +GetMoreFragment()
...
{
    os << "( nextHeader = " << +GetNextHeader() << " length = " << +GetLength()
       << " typeRouting = " << +m_typeRouting << " segmentsLeft = " << +m_segmentsLeft << " )";
}
...
{
    os << "( nextHeader = " << +GetNextHeader() << " length = " << +GetLength()
       << " typeRouting = " << +GetTypeRouting() << " segmentsLeft = " << +GetSegmentsLeft() << " ";
