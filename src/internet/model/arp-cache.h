  ...
  public:
    ...
    class Entry
    {
      public:
        ...
        /**
         * @return True if the state of this entry is stale; false otherwise.
         */
        bool IsStale();
        /**
         * @brief Changes the state of this entry to DELAY.
         */
        void MarkDelay();
        /**
      ...
      private:
        ...
        Time m_expiry;                //!< The absolute time when this entry changes state
