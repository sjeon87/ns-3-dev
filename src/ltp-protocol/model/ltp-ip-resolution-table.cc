...
{
    static TypeId tid =
        TypeId("ns3::LtpIpResolutionTable")
            .SetParent<Object>()
...
bool
LtpIpResolutionTable::AddBinding(uint64_t dstLtpEngineId, Ipv4Address dstAddr)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr);
    return (m_ltpToIpv4Addr.insert(
                std::pair<uint64_t, InetSocketAddress>(dstLtpEngineId, InetSocketAddress(dstAddr))))
        .second;
}

bool
LtpIpResolutionTable::AddBinding(uint64_t dstLtpEngineId, Ipv4Address dstAddr, uint16_t dstPort)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr << " " << dstPort);
    return (m_ltpToIpv4Addr.insert(
                std::pair<uint64_t, InetSocketAddress>(dstLtpEngineId,
                                                       InetSocketAddress(dstAddr, dstPort))))
        .second;
}

bool
LtpIpResolutionTable::AddBinding(uint64_t dstLtpEngineId, Ipv6Address dstAddr)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr);
    return (m_ltpToIpv6Addr.insert(
                std::pair<uint64_t, Inet6SocketAddress>(dstLtpEngineId,
                                                        Inet6SocketAddress(dstAddr))))
        .second;
}

bool
LtpIpResolutionTable::AddBinding(uint64_t dstLtpEngineId, Ipv6Address dstAddr, uint16_t dstPort)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr << " " << dstPort);
    return (m_ltpToIpv6Addr.insert(
                std::pair<uint64_t, Inet6SocketAddress>(dstLtpEngineId,
                                                        Inet6SocketAddress(dstAddr, dstPort))))
        .second;
}

bool
LtpIpResolutionTable::RemoveBinding(uint64_t dstLtpEngineId, Ipv4Address dstAddr)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr);
...
bool
LtpIpResolutionTable::RemoveBinding(uint64_t dstLtpEngineId, Ipv4Address dstAddr, uint16_t dstPort)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr << " " << dstPort);
...
bool
LtpIpResolutionTable::RemoveBinding(uint64_t dstLtpEngineId, Ipv6Address dstAddr)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr);
...
bool
LtpIpResolutionTable::RemoveBinding(uint64_t dstLtpEngineId, Ipv6Address dstAddr, uint16_t dstPort)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId << " " << dstAddr << " " << dstPort);
    return RemoveBinding(dstLtpEngineId, dstAddr);
}
...
InetSocketAddress
LtpIpResolutionTable::GetIpv4Route(uint64_t dstLtpEngineId)
{
...
Inet6SocketAddress
LtpIpResolutionTable::GetIpv6Route(uint64_t dstLtpEngineId)
{
    NS_LOG_FUNCTION(this << " " << dstLtpEngineId);
...
void
LtpIpResolutionTable::PrintIpv4Bindings(Ptr<OutputStreamWrapper> stream) const
{
...
void
LtpIpResolutionTable::PrintIpv6Bindings(Ptr<OutputStreamWrapper> stream) const
{
    NS_LOG_FUNCTION(this << stream);
    std::ostream* os = stream->GetStream();
...
Address
LtpIpResolutionTable::GetRoute(uint64_t LtpEngineId)
{
...
AddressMode
LtpIpResolutionTable::GetAddressMode() const
{
    NS_LOG_FUNCTION(this);
