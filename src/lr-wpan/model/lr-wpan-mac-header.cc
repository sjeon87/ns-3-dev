...
LrWpanMacHeader::Print(std::ostream& os) const
{
    os << "  Frame Type = " << +m_fctrlFrmType
       << ", Sec Enable = " << +m_fctrlSecU
       << ", Frame Pending = " << +m_fctrlFrmPending
       << ", Ack Request = " << +m_fctrlAckReq
       << ", PAN ID Compress = " << +m_fctrlPanIdComp
       << ", Frame Vers = " << +m_fctrlFrmVer
       << ", Dst Addrs Mode = " << +m_fctrlDstAddrMode
       << ", Src Addr Mode = " << +m_fctrlSrcAddrMode;
