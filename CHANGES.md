...
* (network) The `Buffer::Iterator` `WriteHtolsbU[16,32,64]()` and `ReadLsbtohU[16,32,64]()` methods have been deprecated; use the documented `WriteU[16,32,64]()`/`ReadU[16,32,64]()` little-endian methods instead.
